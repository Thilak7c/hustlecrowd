const CardDark2 = ({product}) => {
  return (
    <a href={product.url} className='bg-[#353739] hover:cursor-pointer rounded-lg overflow-hidden drop-shadow-md hover:drop-shadow-lg font-circular mb-1 mx-1'>
