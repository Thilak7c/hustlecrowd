...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-white pt-20 pb-10 lg:pt-[120px] lg:pb-20  font-circular">
        <div className="container">
          <div className="flex flex-wrap justify-between pl-4 md:pl-0">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                <Link to="/" className='mb-6 inline-block max-w-[160px] font-circular text-2xl font-bold text-gray-700 hover:cursor-pointer'>
                  HustleCrowd
                </Link>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
              <div className="w-full mb-10">
                ...
                <p className="text-base text-body-color">
                  {" "}
                  © {new Date().getFullYear()} TECHCROWD{" "}
                </p>
              </div>
            </div>
          </div>
